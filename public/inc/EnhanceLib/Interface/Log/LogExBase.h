...
#define LOG_TRACE(Moduel, ...)                                                                       \
    if (CLogEx::GetModuleMask() & (1 << Moduel)) {                                                               \
        LogBase_printf(MODULE_NAME, LOG_LEVEL_TRACE, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__); \
    }

#define LOG_DEBUG(Moduel, ...)                                                                       \
    if (CLogEx::GetModuleMask() & (1 << Moduel)) {                                                               \
        LogBase_printf(MODULE_NAME, LOG_LEVEL_DEBUG, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__); \
    }

#define LOG_INFO(Moduel, ...)                                                                       \
    if (CLogEx::GetModuleMask() & (1 << Moduel)) {                                                              \
        LogBase_printf(MODULE_NAME, LOG_LEVEL_INFO, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__); \
    }

#define LOG_WARN(Moduel, ...)                                                                       \
    if (CLogEx::GetModuleMask() & (1 << Moduel)) {                                                              \
        LogBase_printf(MODULE_NAME, LOG_LEVEL_WARN, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__); \
    }

#define LOG_ERROR(Moduel, ...)                                                                       \
    if (CLogEx::GetModuleMask() & (1 << Moduel)) {                                                               \
        LogBase_printf(MODULE_NAME, LOG_LEVEL_ERROR, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__); \
    }

#define LOG_FATAL(Moduel, ...)                                                                       \
    if (CLogEx::GetModuleMask() & (1 << Moduel)) {                                                               \
        LogBase_printf(MODULE_NAME, LOG_LEVEL_FATAL, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__); \
    }
