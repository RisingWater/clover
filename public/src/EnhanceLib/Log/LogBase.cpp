...
#include <map>
#ifdef _WIN32
#include "Windows/LogBase_OsWin.h"
#else
#include "Linux/LogBase_OsUnix.h"
#endif
...
#endif
    m_logfile = Log_OsGetFullPathNameRelativeExec(_T("LogBase.log"));
 ...
 *  载入log系统的配置文件
 */
static BOOL LoadLogConf(const TCHAR *config_file)
{
    Log_OsLock();
    {
        TCHAR buf[MAX_CONF_BUF_SIZE];
...
#ifdef _UNICODE
void WINAPI LogBase_printfW
#else
void WINAPI LogBase_printfA
#endif
...
#ifdef _UNICODE
void WINAPI LogBase_dumpW
#else
void WINAPI LogBase_dumpA
#endif
...
#ifdef _UNICODE
void WINAPI LogBase_SetOptStrW
#else
void WINAPI LogBase_SetOptStrA
#endif
...
#ifdef _UNICODE
void WINAPI LogBase_SetOptIntW
#else
void WINAPI LogBase_SetOptIntA
#endif
(const TCHAR *modulename,
    const TCHAR *filedname,
    int value)
...
#ifdef _UNICODE
int WINAPI LogBase_initExW
#else
int WINAPI LogBase_initExA
#endif
...
#ifdef _UNICODE
int WINAPI LogBase_initW
#else
int WINAPI LogBase_initA
#endif
